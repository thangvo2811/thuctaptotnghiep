					...
					<div class="module-01 clearfix">
						<div class="dm-1 danhmuc clearfix">
                            ...
                            <div class="div-donhang">
                                ...
                                {
                                    ?>
                                <div class="div-donhang-madonhang-left">Tình Trạng Đơn:   Đang chờ giao</div>
                                <div class="div-donhang-madonhang-right"><a href="./for-shipper.php?madh=<?php echo $dhh['madh']?>">Giao Hàng Ngày</a></div>
                                <?php
                                }
                                ?>
                            </div>
